...
import ChannelCreationFrom from "@/components/channel/channelCreationFrom";
...
const ECommerce = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
    await http_post_request({ endpoint: '/channel/v1/postChannel', data: { ...channelProfile } }).then(function (authRes) {
              ...
              <div className="p-7">
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center space-y-3">
                   ...
                   <IconButton iconName={FaPlus} buttonText="Create new Channel" onClick={toggleModal} />
                  </div>
                </div>
