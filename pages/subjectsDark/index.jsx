...
const Subjects = () => {
    ...
    const totalPages = Math.ceil(filteredPackageData.length / itemsPerPage);
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            ...
            <div className="flex justify-between mt-4">
                <div className="flex">
                    <button
                        className="cursor-pointer mx-1 px-3 py-2 rounded bg-gray-200"
                    ...
                    {Array.from({ length: totalPages }).map((_, index) => (
                        <button
                            key={index}
                            className={`cursor-pointer mx-1 px-3 py-2 rounded ${currentPage === index + 1 ? "bg-primary text-white" : "bg-gray-200"
                                }`}
