import { LOCATION_END_POINT } from '@/constants';
...
const DeleteModal = ({ isOpen, onClose, data, isParentRender }) => {
    ...
    const deleteData = async () => {
        try {
            const deleteSubject = await del(LOCATION_END_POINT.delete(data?._id));
