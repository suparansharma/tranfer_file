...
const SubjectForm = ({ isOpen, onClose }) => {
  // console.log("calling",isModalOpen);
  return (
      ...
      {isOpen && (
        <div className="fixed inset-0 z-10 overflow-y-auto ">
          <div className="flex items-center justify-center min-h-screen">
            ...
            <div className="relative bg-white p-8 rounded-lg  dark:border-strokedark dark:bg-boxdark">
              {/* Modal content */}
                ...
                <div className="grid gap-4 mb-4 grid-cols-2">
                  ...
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <input
                      ...
                      name="price"
                      id="price"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      placeholder="$2999"
                      required=""
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea
                      id="description"
                      rows={4}
                      className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500  dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
